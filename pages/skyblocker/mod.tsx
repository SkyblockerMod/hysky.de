...
export const getServerSideProps = async () => {
    const res = await fetch('https://img.shields.io/github/v/tag/SkyblockerMod/skyblocker.json?label=&cacheSeconds=3600')
    const github: Github = await res.json()
    const res2 = await fetch('https://raw.githubusercontent.com/SkyblockerMod/Skyblocker/master/FEATURES.md')
...
function Skyblocker({ github, features }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        <>
            <Head data-theme="">
                <title>Skyblocker Mod - Hysky</title>
            </Head>
                    ...
                    <div className="card-body">
                        ...
                        <div className="mb-4 space-x-2 card-actions text-center">
                            ...
                            <div className="badge badge-ghost font-bold ">
                                <a href="https://github.com/SkyblockerMod/Skyblocker/releases/latest"
                                    className=" text-info">
                                    Download
                                </a>
                            </div>
                            <div className="badge badge-ghost font-bold ">
                                <a href="https://github.com/SkyblockerMod/Skyblocker" className=" text-error">
                                    Source
                                </a>
                            </div>
                            <div className="badge badge-ghost font-bold ">
                            ...
                            <div className="badge badge-ghost font-bold ">
                                <a href="https://github.com/SkyblockerMod/Skyblocker/actions/workflows/beta.yml"
